...
def plot_curves(auroc, valid):
    ...
    if auroc:
        plt.ylabel("AUROC")
        if valid:
            aucs = [c10_1000_val_roc, c10_10000_val_roc, c10_val_roc, c100_val_roc, effnet_val_roc]
        else:
        ...
        plt.ylabel("AUPR")
        if valid:
            aucs = [c10_1000_val_pr, c10_10000_val_pr, c10_val_pr, c100_val_pr, effnet_val_pr]
        else:
